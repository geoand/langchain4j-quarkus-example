    ...
    render() {
        return html`
            ...
            <div class="explanation">
                This demo shows how to build a chat bot powered by an LLM and retrieval augmented generation.
                The description of the different accounts is ingested into an Embedding store and relevant information
            ...
            <div class="explanation">
                <ol>
                    ...
                    <li>The application looks for relevant data in the Embedding store.</li>
